...
#include <sstream>
using namespace std;
MyTestApp::MyTestApp(HWND parent):TwainAppInterface(parent)
{
...
TwainApp::DSMCallback * MyTestApp::getDSMCallbackFunction()
{
    return DSMCallbackFunc;
}


void MyTestApp::fillIdentity(TW_IDENTITY & _identity)
{
    _identity.Id = 0;
...
//////////////////////////////////////////////////////////////////////////////
string MyTestApp::getErrorString_UnexpectedType(const TW_UINT16 _unExpected, const TW_UINT16 _unReceived)
{
...
//////////////////////////////////////////////////////////////////////////////
void MyTestApp::print_ICAP(const TW_UINT16 _unCap, pTW_ONEVALUE _pCap)
{
    if (nullptr == _pCap)
    {
        return;
...
//////////////////////////////////////////////////////////////////////////////
void MyTestApp::print_ICAP(const TW_UINT16 _unCap, pTW_ENUMERATION _pCap)
{
    if (nullptr == _pCap)
    {
        return;
